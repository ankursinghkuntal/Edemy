  ...
  return courseData ?  (
    ...
    md:px-36 px-8 md:pt-30 pt-20 text-left bg-gradient-to-b from-cyan-100/70'>
      ...
      <div className="absolute top-0 left-0 w-full h-[500px] -z-1"></div>
        ...
        <div className='max-w-xl z-10 text-grey-500'>
          ...
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
            ...
            <div className='flex'>
              ...
              src={i < Math.floor(calculateRating(courseData)) ? assets.star : assets.star_blank} alt="star" className='w-3.5 h-3.5' /> )
            )}
            </div>
                ...
                {courseData.courseContent.map((chapter, index) => (
                  <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ${openSections[index] ? 'max-h-96' : 'max-h-0'}` }>
                        <ul className='list-disc md:pl-10 pl-4 pc-4 py-2 text-gray-600 border-t border-gray-300'>
                        {chapter.chapterContent.map((lecture, i) => (
                          <li key={i} className="flex items-start gap-2 py-1 pr-2">
                            <img src={assets.play_icon} alt="play_icon" className='w-4 h-4 mt-1'/>
                            <div className='flex items-center justify-between w-full taxt-gray-800 text-xs md:text-default'>
        ...
        {/* right col */}
        <div className="
          bg-white shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] 
          rounded-t md:rounded-none overflow-hidden 
          z-10 max-w-[424px] min-w-[300px] sm:min-w-[420px]
        ">
            ...
            <div className='p-5'>
                ...
                <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gary-500'>
                ...
                <div className='pt-6'>
                  ...
                  <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gary-500'>
