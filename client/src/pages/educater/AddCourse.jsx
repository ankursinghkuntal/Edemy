    ...
    if(action === 'add'){
      ...
      if(title){
        const newChapter = {
          ...
          chapterTitle: title,
          chapterContent: [],
          collapsed: false,  // it will get collapsed and hide lectures inside this chapter 
    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
          ...
          <div>
            ...
            {
              showPopup && (
              <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-0pacity-50'>
